...
module.exports = function (app) {
  ...
  app.post(
    "/api/products",
    [authJwt.verifyToken],
    uploadCsv.fields([{ name: "csvFilePath" }]),
    handleMulterError,
  ...
  app.post(
    "/api/products/images",
    [authJwt.verifyToken],
    uploadImages.fields([{ name: "images" }]),
    handleMulterError,
    productController.createProductsImages
  );
  ...
  app.post(
    ...
    uploadImages.fields([{ name: "images" }]),
    handleMulterError,
    productController.createProductsSingleRecord
  );
  ...
  /* End Point to  delete Product images with product id 
        DELETE '/api/products/images/:id'End Point
        productController.delProductImages - Controller function to delete Product images with product id 
    */
  app.delete(
