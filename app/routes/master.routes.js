...
module.exports = function (app) {
    ...
    */
    ...
    /**
    * Endpoint to post Language Master details 
    * @param {String} ''/api/language/' - API endpoint path.
    * @param {Function[]} [authJwt.verifyToken,
    * @param {Function} languageMaster.saveLanguageMaster,- Controller function to post Language Master details **/

    app.post(
        '/api/language/',
        [authJwt.verifyToken],
        masterController.saveLanguageMaster,
    );

    /**
    * Endpoint to get Language Master details 
    * @param {String} '/api/language' - API endpoint path.
    * @param {Function[]} [authJwt.verifyToken,
    * @param {Function} masterController.getAllLanguageMaster,,- Controller function to get Language Master details **/

    app.get(
        '/api/language/',
        [authJwt.verifyToken],
        masterController.getAllLanguageMaster,
    );

    /**
    * Endpoint to get Language Master details by ID
    * @param {String} '/api/language/:language_id' - API endpoint path.
    * @param {Function[]} [authJwt.verifyToken,
    * @param {Function}  masterController.getByIdLanguageMaster,- Controller function to get Language Master details **/

    app.get(
        '/api/language/:language_id',
        [authJwt.verifyToken],
        masterController.getByIdLanguageMaster,
    );

    /**
    * Endpoint to put Language Master details by ID
    * @param {String} '/api/language/language_id' - API endpoint path.
    * @param {Function[]} [authJwt.verifyToken,
    * @param {Function}  masterController.updateLanguageMaster,- Controller function  to put Language Master details by ID**/

    app.put(
        '/api/language/:language_id',
        [authJwt.verifyToken],
        masterController.updateLanguageMaster,
    );


    /**
    * Endpoint to Delete Language Master details by ID
    * @param {String} '/api/language/language_id' - API endpoint path.
    * @param {Function[]} [authJwt.verifyToken,
    * @param {Function}   masterController.delLanguageMaster,,- Controller function  to Delete Language Master details by ID**/

    app.delete(
        '/api/language/:language_id',
        [authJwt.verifyToken],
        masterController.delLanguageMaster,
    );

    /**
    * Endpoint to search Language Master details by field value and field name.
    * @param {String} '/api/language/language_id' - API endpoint path.
    * @param {Function[]} [authJwt.verifyToken,
    * @param {Function}   masterController.searchLanguageMaster,- Controller function to search Language Master details by field value and field name.**/

    app.get(
        '/api/language/search/:fieldName/:fieldValue',
        [authJwt.verifyToken],
        masterController.searchLanguageMaster,
    );

    //***************************************Education*************************************//
    /**
    * Endpoint to post Education Master details 
    * @param {String} '/api/education/' - API endpoint path.
    * @param {Function[]} [authJwt.verifyToken,
    * @param {Function} languageMaster.saveEducationMaster,- Controller function to post Language Master details **/

    app.post(
        '/api/education/',
        [authJwt.verifyToken],
        masterController.saveEducationMaster,
    );


    /**
    * Endpoint to get Education Master details 
    * @param {String} '/api/education/' - API endpoint path.
    * @param {Function[]} [authJwt.verifyToken,
    * @param {Function} masterController.getAllEducationMaster,,- Controller function to get Language Master details **/

    app.get(
        '/api/education/',
        [authJwt.verifyToken],
        masterController.getAllEducationMaster,
    );

    /**
    * Endpoint to get Education Master details by ID
    * @param {String} '/api/education/:education_id' - API endpoint path.
    * @param {Function[]} [authJwt.verifyToken,
    * @param {Function}  masterController.getByIdEducationMaster,- Controller function to get Language Master details **/

    app.get(
        '/api/education/:education_id',
        [authJwt.verifyToken],
        masterController.getByIdEducationMaster,
    );

    /**
    * Endpoint to put Education Master details by ID
    * @param {String} '/api/education/:education_id' - API endpoint path.
    * @param {Function[]} [authJwt.verifyToken,
    * @param {Function}  masterController.updateEducationMaster,- Controller function  to put Language Master details by ID**/

    app.put(
        '/api/education/:education_id',
        [authJwt.verifyToken],
        masterController.updateEducationMaster,
    );


    /**
    * Endpoint to Delete Education Master details by ID
    * @param {String} '/api/education/:education_id' - API endpoint path.
    * @param {Function[]} [authJwt.verifyToken,
    * @param {Function}   masterController.delEducationMaster,- Controller function  to Delete Education Master details by ID**/

    app.delete(
        '/api/education/:education_id',
        [authJwt.verifyToken],
        masterController.delEducationMaster,
    );

    /**
    * Endpoint to search Education Master details by field value and field name.
    * @param {String} '/api/education/search/:fieldName/:fieldValue' - API endpoint path.
    * @param {Function[]} [authJwt.verifyToken,
    * @param {Function}   masterController.searchEducationMaster,,- Controller function to search Education Master details by field value and field name.**/

    app.get(
        '/api/education/search/:fieldName/:fieldValue',
        [authJwt.verifyToken],
        masterController.searchEducationMaster,
    );
};